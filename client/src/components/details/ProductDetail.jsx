  ...
  return (      
        <>
            ...
            <Typography style={{ marginTop: 5, color: '#878787', fontSize: 14}}>
                 ...
                 <Box component="span"> <img src={fassured} style={{ width:77, marginLeft: 20}} alt='logo'/></Box>      
            </Typography>
            <Typography>
            ...
            <Typography>Available offers</Typography>
             <SmallText>
                 ...
                 <Typography><StyledBadge/>Sign up for Flipkart Pay Later and get Flipkart Gift Card wroth ₹100* Know More </Typography>
